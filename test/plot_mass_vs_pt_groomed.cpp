{
  ...
  MassPt3->GetXaxis()->SetRangeUser(300,1000);
  MassPt4->GetXaxis()->SetRangeUser(300,1000);
  MassPt5->GetXaxis()->SetRangeUser(300,1000);
  ...
  ProfileMassPt3->GetYaxis()->SetRangeUser(0,220);
  ProfileMassPt4->GetYaxis()->SetRangeUser(0,220);
  ProfileMassPt5->GetYaxis()->SetRangeUser(0,220);
  ...
  ProfileMassPt2 -> Draw("E1");
  ProfileMassPt3-> Draw("E1same");
